...
const char* SSID = "Galaxy S9bd0a";
const char* password = "maxime26";
...
void loop() {
  ...
  client.println("</br>");
  client.println("<a href=\https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Ffr%2Fphotos%2Farbre-le-coucher-du-soleil-736885%2F&psig=AOvVaw10MQoCuIKDkpeCSSiHbunD&ust=1680624606935000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCMjQxNeMjv4CFQAAAAAdAAAAABAE" target=\"_blank\">See the Instructables Page: ESP8266 WiFi Module for Dummies</a></br>");
